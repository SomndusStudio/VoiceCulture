...
void FSSVoiceFilterActorName::UpdateData()
{
	...
	USSVoiceLocalizationEditorSubsystem::GetAssetsFromVoiceActor(AssetsUsed, VoiceActorName, false);
...
void FSSVoiceFilterMissingCulture::UpdateData()
{
	...
	USSVoiceLocalizationEditorSubsystem::GetAssetsWithMissingCulture(AssetsUsed, false);
...
{
	TArray<FAssetData> AssetsUsed = VoiceAssets.Array();
	USSVoiceLocalizationEditorSubsystem::GetAssetsWithCompleteCulture(AssetsUsed, false);
